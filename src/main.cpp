...
// Copyright (c) 2013-2014 Thebotcoin Developers
...
uint256 hashGenesisBlock("0x78f5c2d2f46181ad08adfb95eee440a3db54f184a7fba53cb6b00d44ea264a3c");
...
const string strMessageMagic = "Thebotcoin Signed Message:\n";
...
static const int64 nTargetTimespan = 300 * 10; // Thebotcoin: every 10 blocks
static const int64 nTargetSpacing = 300; // Thebotcoin: 300 second blocks
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal Thebotcoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Thebotcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x78f5c2d2f46181ad08adfb95eee440a3db54f184a7fba53cb6b00d44ea264a3c");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Thebotcoin..";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1395258025; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2237394;

        if (fTestNet)
        {
            block.nTime    = 1395258025;
            block.nNonce   = 2237394;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0xc856089f6870d75f66dd6df22f6b05b09d39ea75a02323300240cdea59a199b9"));
